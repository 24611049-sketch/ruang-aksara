...
<div class="p-6">
    <div class="max-w-4xl mx-auto">
        ...
        <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2 mt-1">
                            ...
                            <button type="button" onclick="openCategoryModalBooks()" 
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="harga" id="harga" min="0" step="1"
                               class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="number" name="profit_margin_percent" id="profit_margin_percent" value="{{ old('profit_margin_percent', 35) }}" required min="0" max="100" step="1"
                    ...
                    <div>
                        ...
                        <input type="number" name="berat" id="berat" value="{{ old('berat', 500) }}" required min="1" step="1"
                               class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="halaman" id="halaman" value="{{ old('halaman') }}" required min="1" 
                               class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    </div>
            ...
            <div class="mt-6">
                ...
                <textarea name="deskripsi" id="deskripsi" rows="4" required
                          class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('deskripsi') }}</textarea>
            </div>
            ...
            <div class="mt-8 flex space-x-4">
                ...
                <button type="button" onclick="handleBatal()" class="bg-gray-300 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-400 flex items-center">
